    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=($good->gallery)[0]->path."?imageView2/1/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=($good->gallery)[0]->path."?imageView2/1/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach ($good->gallery as $k1=>$img):?>
                                <li <?=$k1==0?'class="cur"':''?>>
                                    <a <?=$k1==0?'class="zoomThumbActive"':''?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->path."?imageView2/1/w/350/h/350"?>',largeimage: '<?=$img->path."?imageView2/1/w/800/h/800"?>'}"><img src="<?=$img->path."?imageView2/1/w/50/h/50"?>"></a>
                                </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li><span>上架时间：</span><?=date("Ymd H:i:s",$good->inputtime)?></li>
